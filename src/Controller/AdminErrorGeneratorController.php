...
class AdminErrorGeneratorController extends FrameworkBundleAdminController
{
    ...
    {
        return $this->render('@Modules/errorgenerator/views/templates/admin/error.html.twig');
    }
}
